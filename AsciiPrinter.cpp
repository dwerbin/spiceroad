...
inline _SpicePrint spice_color(Spice spice) { return {spice}; }

template <class CharT, class Traits>
constexpr std::basic_ostream<CharT, Traits>& operator<<(
    std::basic_ostream<CharT, Traits>& os, _SpicePrint spice_print) {
...
static std::ostream& print_item(std::ostream& stream,
                                const std::vector<Spice>& v,
                                unsigned int index) {
    if (v.size() > index) {
...
std::ostream& AsciiPrinter::print(std::ostream& stream, const Game& game) {
    stream << "           ";
    stream << "   " << std::setw(2) << ansi::foreground_yellow
           << game.get_gold_coin_count() << "©" << ansi::reset;
    stream << "    ";
...
std::ostream& AsciiPrinter::print(std::ostream& stream, const Player& player) {
    ...
    stream << "| SCORE:     " << std::setw(2) << player.get_score(false)
           << std::endl;
    stream << " └─────────────┘" << std::endl;
...
std::ostream& AsciiPrinter::print(std::ostream& stream, const Buyable* buyable,
                                  unsigned int line) {
    if (buyable == nullptr) {
        return stream << "         ";
    }
...
std::ostream& AsciiPrinter::print(std::ostream& stream,
                                  const Merchant* merchant, unsigned int line) {
    if (merchant == nullptr) {
        return stream << "         ";
    }
...
std::ostream& AsciiPrinter::_print(std::ostream& stream,
...
std::ostream& AsciiPrinter::_print(std::ostream& stream, const Trade* trade,
                                   unsigned int line) {
    if (trade == nullptr) {
        return stream << "         ";
    }
...
std::ostream& AsciiPrinter::_print(std::ostream& stream, const Upgrade* upgrade,
                                   unsigned int line) {
    if (upgrade == nullptr) {
        return stream << "         ";
    }
