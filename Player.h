...
namespace sr
{
    ...
    public:
        ...
        const SpiceMap& get_caravan() const {
            return caravan;
        }
        SpiceMap& get_caravan() {
            return caravan;
        }
        const std::unordered_set<const Merchant*>& get_hand() const {
            return hand;
        }
    ...
    private:
        std::unordered_set<const Merchant*>::iterator check_merchant_card_in_hand(const Merchant& card);
